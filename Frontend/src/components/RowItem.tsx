...
export const RowItem = ({ proveedor, onClick }: { proveedor: Proveedor; onClick: () => void }) => {
  ...
  return (
    <div
      className='flex items-center gap-2 px-2 py-4 bg-white rounded-2xl shadow-sh-sm'
      onClick={onClick}>
...
export const RowTiempo = ({ title }: { title: string }) => {
  return (
    <div className='flex items-center gap-2 px-2 py-4 rounded-2xl w-[375px] bg-white shadow-sh-sm'>
      <div className='flex items-start flex-1 min-w-0 gap-2'>
